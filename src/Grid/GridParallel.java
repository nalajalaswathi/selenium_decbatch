...
public class GridParallel 
{
  ...
  public void TC2() throws MalformedURLException 
  {
		...
		capability.setPlatform(Platform.XP);
		WebDriver driver = new RemoteWebDriver(new URL("http://192.168.0.134:6565/wd/hub"),capability);
  ...
  public void TC3() throws MalformedURLException 
  {
		...
		capability.setPlatform(Platform.XP);
		WebDriver driver = new RemoteWebDriver(new URL("http://192.168.0.134:4545/wd/hub"),capability);
